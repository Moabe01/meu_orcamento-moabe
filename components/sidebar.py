...
# ========= Layout ========= #
layout = dbc.Col([
                html.H1("Dashboard Financeiro", className="text-primary"),
                html.P("By Moabe Silva", className="text-info"),
                html.Hr(),
            ...
            dbc.ModalBody([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        dbc.Select(id="select_receita", options=[{"label": i, "value": i} for i in cat_receita],
                                   value=cat_receita[0])
                    ], width=4)
    ...
    dbc.Modal([
        ...
        dbc.ModalBody([
            dbc.Row([
                dbc.Col([
                    dbc.Label("Descrição: "),
                    dbc.Input(placeholder="Ex.: Aluguel, gasolina, luz...", id="txt-despesa"),
                ], width=6),
                dbc.Col([
                    dbc.Label("Valor: "),
